...
> 🇬🇧 **[English Documentation / Englische Dokumentation](../../README.md)**
...
[Vollständige Konfigurations-Dokumentation](CONFIGURATION.md)
...
|---|---|---|
| `module_base` | System-Grundkonfiguration (NTP, Locale, User, Basics) | [modules/base.md](modules/base.md) |
| `module_security` | Firewall (nftables), SSH-Härtung, CrowdSec | [modules/security.md](modules/security.md) |
| `module_network` | Netzwerk & VPN (z. B. WireGuard) | [modules/network.md](modules/network.md) |
| `module_container` | Docker/Moby installieren & Basis-Setup | [modules/container.md](modules/container.md) |
| `module_deploy_containers` | Container-Stacks deployen (Compose etc.) | [modules/deploy_containers.md](modules/deploy_containers.md) |
| `module_geoip` | Länderbasiertes Blocking (GeoIP-Sets) | [modules/geoip.md](modules/geoip.md) |
| `module_install_services` | Basis-Dienste/Tools installieren | [modules/install_services.md](modules/install_services.md) |
| `module_journald_optimization` | journald persistent + Limits/Rotation | [modules/journald_optimization.md](modules/journald_optimization.md) |
| `module_kernel_hardening` | Kernel/Sysctl-Härtung | [modules/kernel_hardening.md](modules/kernel_hardening.md) |
| `module_mail_setup` | Systemweite Mail via msmtp | [modules/mail_setup.md](modules/mail_setup.md) |
| `module_prepare_install` | Vorbereitungen (Repos, Keys, Checks) | [modules/prepare_install.md](modules/prepare_install.md) |
| `module_cleanup` | Aufräumen von Altlasten/Paketen | [modules/cleanup.md](modules/cleanup.md) |
| `module_system_update` | Templatebasierte unattended-upgrades (Debian 12/13) | [modules/system_update.md](modules/system_update.md) |
| `module_verify_setup` | Finale Überprüfung/System-Checks | [modules/verify_setup.md](modules/verify_setup.md) |
...
**[Dokumentation](./) | [Changelog](../../CHANGELOG.md) | [Konfiguration](CONFIGURATION.md) | [Wiki](../../../../wiki)**
